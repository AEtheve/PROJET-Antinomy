...
public class MenuJeuGraphique extends JComponent{
    ...
    public MenuJeuGraphique(InterfaceGraphique ig){
        ...
        bg[0] = new MenuButton(local,"VS_joueur.png", (JComponent) this);
        bg[1] = new MenuButton(ia, "VS_IA.png", (JComponent) this);
        bg[2] = new MenuButton(online,"VS_online.png", (JComponent) this);
        bg[3] = new MenuButton(retour,"Fleche_retour_menu.png", (JComponent) this);
