...
public class Indice extends JComponent {
    Carte carte;
    ...
    public Indice(ControleurMediateur ctrl, String type, HashMap<String, Image> imagesCache) {
    ...
    public Image getImage() {
        return Configuration.lisImage("Indice", imagesCache);
    }
